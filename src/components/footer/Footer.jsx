          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="d-flex justify-content-start">Pink Floyd</div>
              </div>
            ...
            <div className="d-flex flex-column justify-content-between align-items-center">
              ...
              >
                <audio
                  ...
                  loop=""
                ></audio>
                <span id="current-time" className="time d-none d-sm-block">
                  0:00
                </span>
                <input
                  type="range"
          ...
          <div className="footer-mobile-player d-flex align-items-center">
            <div className="container d-flex align-items-center">
              ...
              <div className="mobile-player-song-div d-flex flex-column">
                <div className="mobile-player-song">The Division Bell</div>
                <div className="mobile-player-artist">Pink Floyd</div>
              </div>
              <div className="mobile-player-icons d-flex align-items-center">
                <div className="mr-3">
